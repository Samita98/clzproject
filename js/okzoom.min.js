...
$(function(a) { var b = function(c) { c = c.toLowerCase(); var d = /(chrome)[ \/]([\w.]+)/.exec(c) || /(webkit)[ \/]([\w.]+)/.exec(c) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(c) || /(msie) ([\w.]+)/.exec(c) || c.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(c) || [],
                e = { browser: d[1] || "", version: d[2] || "0" }; return b = {}, e.browser && (b[e.browser] = !0, b.version = e.version), b.chrome ? b.webkit = !0 : b.webkit && (b.safari = !0), window.$ && (a.browser = b), b }(navigator.userAgent),
